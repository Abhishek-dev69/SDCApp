...
export default function AdminTimetableScreen({ navigation }) {
  ...
  const handleStartLecture = () => runLectureAction('start', 'Could not start lecture.');
  const handleCompleteLecture = () => runLectureAction('complete', 'Could not mark lecture conducted.');
              ...
              <>
                ...
                {selectedLecture.status === 'scheduled' && (
                  <View style={styles.sheetActions}>
                    ...
                    <TouchableOpacity style={[styles.sheetBtn, styles.btnDanger]} onPress={cancelLecture}>
                      <Text style={styles.btnDangerText}>Cancel</Text>
                    </TouchableOpacity>
                  </View>
                )}
